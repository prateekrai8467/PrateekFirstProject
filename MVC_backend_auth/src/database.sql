...
-- ============================================================
-- TABLE 7: payments
-- Tracks charges for room bookings (if applicable)
-- ============================================================
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  `payment_method` ENUM('cash','online','card','upi') DEFAULT NULL,
...
-- ============================================================
-- TABLE 8: fines
-- Tracks fines for late returns or policy violations
-- ============================================================
CREATE TABLE IF NOT EXISTS `fines` (
  ...
  `issued_by`    INT NOT NULL,               -- admin user_id who issued the fine
  `issued_at`    TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`fine_id`),
  KEY `booking_id` (`booking_id`),
  KEY `user_id`    (`user_id`),
  KEY `issued_by`  (`issued_by`),
  CONSTRAINT `fines_ibfk_1` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`) ON DELETE CASCADE,
  CONSTRAINT `fines_ibfk_2` FOREIGN KEY (`user_id`)    REFERENCES `users`    (`user_id`)    ON DELETE CASCADE,
  CONSTRAINT `fines_ibfk_3` FOREIGN KEY (`issued_by`)  REFERENCES `users`    (`user_id`)    ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
